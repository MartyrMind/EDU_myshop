...
# примеры прикладных представлений для сайта администрирования
...
class OrderAdmin(admin.ModelAdmin):
    ...
    inlines = [OrderItemInline]  # позволяет вставлять модель в ту же страницу редактирования, что и связанную с ней
